...
const { initializeSpecializations } = require("./controllers/suggestDoctor");
...
// Ensure embeddings are initialized before server starts
(async () => {
  try {
    ...
    console.error("Failed to initialize specialization embeddings:", err);
    process.exit(1);
  }
})();
