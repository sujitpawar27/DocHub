...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            console.log("res", res);
            if (!res.message == "patient registered successfully") throw new Error(res.data?.message || "Registration failed");
            router.push("/login");
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__37379454._.js.map