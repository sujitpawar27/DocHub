...
function DoctorProfilePage() {
    ...
    const handleAvatarUpload = async (e)=>{
        ...
        setUploading(true);
        const { error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('avatars').upload(`${fileName}`, file, {
            cacheControl: '3600',
            upsert: true
        });
        if (uploadError) {
        ...
        const { data: urlData } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from("avatars").getPublicUrl(filePath);
    ...
    const handleSubmit = async (e)=>{
        ...
        setSaving(true);
        try {
            const updatedUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$doctor$2f$profile$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProfile"])({
                ...profile,
                availability
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65c7c54b._.js.map