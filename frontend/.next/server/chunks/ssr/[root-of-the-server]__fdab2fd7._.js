...
// Helper to get headers with token from localStorage
...
exports.register = async (userData)=>{
    try {
        const response = await axios.post(`${BASE_URI}/api/auth/register`, userData);
...
exports.login = async (credentials)=>{
    try {
        const response = await axios.post(`${BASE_URI}/api/auth/login`, credentials, getAuthHeaders());
        return response.data;
    } catch (error) {
...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["register"])(formData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdab2fd7._.js.map