...
;
;
function DoctorCard({ doctor, onAction, actionLabel = "View Profile" }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bg-white rounded-xl shadow-md p-4 flex flex-col items-center gap-3 border hover:shadow-lg transition",
        children: [
...
function SearchDoctorsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SearchDoctorsPage.useMemo": ()=>{
            const handler = setTimeout({
                "SearchDoctorsPage.useMemo.handler": ()=>setDebouncedSearch(search)
            }["SearchDoctorsPage.useMemo.handler"], 300);
            return ({
                "SearchDoctorsPage.useMemo": ()=>clearTimeout(handler)
            })["SearchDoctorsPage.useMemo"];
        }
    }["SearchDoctorsPage.useMemo"], [
        search
...
_s(SearchDoctorsPage, "gWXQnLSoWwV+0hF2HhHOmNgIXcc=");
...
//# sourceMappingURL=_fb3b927f._.js.map