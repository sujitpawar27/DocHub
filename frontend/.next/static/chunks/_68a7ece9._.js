...
function DoctorProfilePage() {
    ...
    const handleAvatarUpload = async (e)=>{
        ...
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$doctor$2f$profile$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadAvatar"])(formData, file.name);
            setAvatarUrl(data.avatarUrl);
            setProfile((prev)=>({
                    ...prev,
    ...
    const handleSubmit = async (e)=>{
        ...
        setSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$doctor$2f$profile$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateProfile"])({
                ...profile,
                availability
            });
            alert("Profile saved!");
...
//# sourceMappingURL=_68a7ece9._.js.map