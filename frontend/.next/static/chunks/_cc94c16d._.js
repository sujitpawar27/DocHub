...
const getProfile = async ()=>{
    ...
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URI}/me`, {
        headers: {
            ...
            const fetchDoctor = {
                "DoctorProfilePage.useEffect.fetchDoctor": async ()=>{
                    try {
                        ...
                        setDoctor(res);
                        const slotRes = await getDoctorSlots(id);
...
//# sourceMappingURL=_cc94c16d._.js.map