...
function MyAppointmentsPage() {
    ...
    const fetchAppointments = ()=>{
        setLoading(true);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$patient$2f$appointment$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPatientAppointments"])(tab).then((data)=>setAppointments(data)).catch(()=>setAppointments([])).finally(()=>setLoading(false));
    };
...
_s(MyAppointmentsPage, "cX9ot5E2EM7EpdxhkKSawTerds4=");
...
function AppointmentList({ appointments, type, loading }) {
    ...
    const handleCancel = async (apptId)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$patient$2f$appointment$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateAppointmentStatus"])(apptId, "cancelled");
...
//# sourceMappingURL=_dd956730._.js.map